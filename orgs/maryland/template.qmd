...
subtitle: "This document provides the latest results of a few analysis run by the <a href=''>Maryland Department of transportation</a>. It also showcases what's possible to do with <code>lumo</code>, a minimalist quarto template."
format:
  lumo-html: 
...
scale_color_brand <- function() {
  custom_palette <- c( "#f6b313", "#9c1b35", "black", "#070aac", "#DD4124FF")
...
theme_brand <- function() {
  theme_ipsum() +
    theme(
      plot.title = element_text(color = "#a31f37", size = 18, face = "bold"),
      plot.subtitle = element_text(margin = margin(b = 20)),
      axis.text.x = element_text(size = 7),
      axis.text.y = element_text(size = 7),
      plot.background = element_rect(fill = "#f6b3131a", color = NA),
