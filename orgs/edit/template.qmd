---
title: "Edit Program"
subtitle: "This document provides the latest results of a few analysis run by the EDIT program of the North Western University. It also showcases what's possible to do with <code>lumo</code>, a minimalist quarto template."
format:
  lumo-html: 
    logo: "logo.jpg"                                     # Optional. Path to a logo displayed above the title
    ...
    bg-image: "bg-image.jpeg"                                         # Optional: link to an image for the header background
author: Holtz Yan
date: last-modified
---
...
theme_brand <- function() {
  theme_ipsum() +
    theme(
      plot.title = element_text(color = "#3493bb", size = 18, face = "bold"),
      plot.subtitle = element_text(margin = margin(b = 20)),
      axis.text.x = element_text(size = 7),
      axis.text.y = element_text(size = 7),
      plot.background = element_rect(fill = "#3493bb1f", color = NA),
