...
subtitle: "Check how the `lumo` quarto template looks like, and learn how to make it yours in less than 5 minutes. If you like Quarto, you'll love my list of <a href='https://www.productive-r-workflow.com/quarto-tricks'>tips and tricks</a>"
format:
  lumo-html: 
    logo: "logo.png"
