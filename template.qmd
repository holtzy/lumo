---
title: "Epurate: a clean Quarto template"
subtitle: "Check how the `epurate` quarto template looks like, and learn how to make it yours in less than 5 minutes. If you like Quarto, you'll love my list of <a href='https://www.productive-r-workflow.com/quarto-tricks'>tips and tricks</a>"
format:
  epurate-html: 
    logo: "logo.png"
...
This document aims at showcasing how a quarto document made with the `epurate` format looks like.
